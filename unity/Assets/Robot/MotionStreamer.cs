...
public class MotionStreamer : MonoBehaviour
{
    ...
    private readonly string appName = "Quest"; // A fun name to ID the client in the robot logs
    private readonly string serverAddress = "10.4.69.2"; // RoboRIO IP Address (typically 10.TE.AM.2)
